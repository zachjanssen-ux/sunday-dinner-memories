-- Drop the old function with too many parameters
DROP FUNCTION IF EXISTS create_recipe;

-- Simpler version that takes a single JSONB parameter
-- PostgREST can always find single-param functions
...
BEGIN
  INSERT INTO recipes (
    ...
    CASE WHEN recipe_data->'dietary_labels' IS NOT NULL
